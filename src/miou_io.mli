...
val openfile : string -> Unix.open_flag list -> Unix.file_perm -> Miou_unix.file_descr
val with_file : string -> Unix.open_flag list -> Unix.file_perm -> (Miou_unix.file_descr -> 'a) -> 'a
